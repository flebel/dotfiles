...
plugins=(autoenv bower cp dirhistory django git git-flow github mercurial nvm pip pyenv pylint python jsontools screen ssh-agent svn tmux torrent vi-mode)
